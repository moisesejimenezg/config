...
-- beautiful.init(awful.util.getdir("config") .. "/themes/powerarrow/theme.lua")
...
for s = 1, screen.count() do
    ...
    mypromptbox[s] = awful.widget.prompt.new({ prompt = "> " })
...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn("stterm -e tmux") end),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () mypromptbox[screen.index]:run() end),

    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run({ prompt = "Run Lua code: " },
                  mypromptbox[screen.index].widget,
                  awful.util.eval, nil,
